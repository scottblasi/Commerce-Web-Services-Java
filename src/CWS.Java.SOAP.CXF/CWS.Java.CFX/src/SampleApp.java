...
import com.ipcommerce.schemas.cws.v2_0.serviceinformation.ArrayOfWorkflowService;
import com.ipcommerce.schemas.cws.v2_0.serviceinformation.BankcardService;
import com.ipcommerce.schemas.cws.v2_0.serviceinformation.CWSServiceInformation;
...
import com.ipcommerce.schemas.cws.v2_0.serviceinformation.ElectronicCheckingMerchantData;
...
import com.ipcommerce.schemas.cws.v2_0.transactions.Addendum;
...
import com.ipcommerce.schemas.cws.v2_0.transactions.CustomerInfo;
import com.ipcommerce.schemas.cws.v2_0.transactions.NameInfo;
...
import com.ipcommerce.schemas.cws.v2_0.transactions.TransactionCustomerData;
import com.ipcommerce.schemas.cws.v2_0.transactions.TransactionData;
import com.ipcommerce.schemas.cws.v2_0.transactions.Unmanaged;
...
import com.ipcommerce.schemas.cws.v2_0.transactions.CVDataProvided;
import com.ipcommerce.schemas.cws.v2_0.transactionprocessing.CwsTransactionProcessing;
...
import com.ipcommerce.schemas.cws.v2_0.transactions.EntryMode;
import com.ipcommerce.schemas.cws.v2_0.transactionprocessing.ICwsTransactionProcessing;
...
import com.ipcommerce.schemas.cws.v2_0.transactions.electronicchecking.CheckCountryCode;
import com.ipcommerce.schemas.cws.v2_0.transactions.electronicchecking.CheckData;
import com.ipcommerce.schemas.cws.v2_0.transactions.electronicchecking.ElectronicCheckingCaptureResponse;
...
import com.ipcommerce.schemas.cws.v2_0.transactions.electronicchecking.ElectronicCheckingTransactionData;
import com.ipcommerce.schemas.cws.v2_0.transactions.electronicchecking.ElectronicCheckingTransactionResponse;
import com.ipcommerce.schemas.cws.v2_0.transactions.electronicchecking.OwnerType;
import com.ipcommerce.schemas.cws.v2_0.transactions.electronicchecking.SECCode;
import com.ipcommerce.schemas.cws.v2_0.transactions.electronicchecking.ServiceType;
import com.ipcommerce.schemas.cws.v2_0.transactions.electronicchecking.TransactionType;
import com.ipcommerce.schemas.cws.v2_0.transactions.electronicchecking.UseType;
...
import com.ipcommerce.schemas.cws.v2_0.dataservices.tms.ArrayOfBatchDetailData;
import com.ipcommerce.schemas.cws.v2_0.dataservices.tms.ArrayOfFamilyDetail;
import com.ipcommerce.schemas.cws.v2_0.dataservices.tms.ArrayOfSummaryDetail;
import com.ipcommerce.schemas.cws.v2_0.dataservices.tms.ArrayOfTransactionDetail;
import com.ipcommerce.schemas.cws.v2_0.dataservices.tms.BatchDetailData;
import com.ipcommerce.schemas.cws.v2_0.dataservices.tms.CWSTransaction;
import com.ipcommerce.schemas.cws.v2_0.dataservices.DateRange;
import com.ipcommerce.schemas.cws.v2_0.dataservices.tms.FamilyDetail;
...
import com.ipcommerce.schemas.cws.v2_0.dataservices.tms.QueryBatchParameters;
import com.ipcommerce.schemas.cws.v2_0.dataservices.tms.QueryBatchResponse;
import com.ipcommerce.schemas.cws.v2_0.dataservices.tms.QueryTransactionFamiliesResponse;
import com.ipcommerce.schemas.cws.v2_0.dataservices.tms.QueryTransactionsDetailResponse;
import com.ipcommerce.schemas.cws.v2_0.dataservices.tms.QueryTransactionsParameters;
import com.ipcommerce.schemas.cws.v2_0.dataservices.tms.QueryTransactionsSummaryResponse;
import com.ipcommerce.schemas.cws.v2_0.dataservices.tms.SummaryDetail;
import com.ipcommerce.schemas.cws.v2_0.dataservices.tms.TransactionDetail;
import com.ipcommerce.schemas.cws.v2_0.*;
import com.ipcommerce.schemas.cws.v2_0.dataservices.tms.faults.TMSBaseFault;
import com.ipcommerce.schemas.cws.v2_0.dataservices.tms.faults.TMSOperationNotSupportedFault;
import com.ipcommerce.schemas.cws.v2_0.dataservices.tms.faults.TMSTransactionFailedFault;
import com.ipcommerce.schemas.cws.v2_0.dataservices.tms.faults.TMSUnavailableFault;
import com.ipcommerce.schemas.cws.v2_0.dataservices.tms.faults.TMSUnknownServiceKeyFault;
import com.ipcommerce.schemas.cws.v2_0.dataservices.tms.QueryBatch;
import com.ipcommerce.schemas.cws.v2_0.dataservices.tms.QueryTransactionsSummary;
import com.ipcommerce.schemas.cws.v2_0.dataservices.tms.QueryTransactionFamilies;
import com.ipcommerce.schemas.cws.v2_0.dataservices.tms.QueryTransactionsDetail;
import com.ipcommerce.schemas.cws.v2_0.dataservices.tms.BatchDetailData;
...
public class SampleApplication {
	...
	private static final QName SIS_SERVICE_NAME = new QName("http://schemas.ipcommerce.com/CWS/v2.0/ServiceInformation", "CWSServiceInformation");
	private static final QName SIS_PORT_NAME = new QName("http://schemas.ipcommerce.com/CWS/v2.0/ServiceInformation", "ServiceInfoProcessing_ICWSServiceInformation");
	private static final QName BCP_SERVICE_NAME = new QName("http://schemas.ipcommerce.com/CWS/v2.0/Transactions", "ICWSBankcard");
	private static final QName BCP_PORT_NAME = new QName("http://schemas.ipcommerce.com/CWS/v2.0/Transactions", "TransactionProcessing_ICWSBankcard");
	private static final QName TMS_SERVICE_NAME = new QName("http://schemas.ipcommerce.com/TMS/v2.0", "ITMSOperations");
	private static final QName TMS_PORT_NAME = new QName("http://schemas.ipcommerce.com/TMS/v2.0", "BasicHttpBinding_ITMSOperations");
	...
	private static String _primaryServiceEndpoint = "https://cws-01.cert.ipcommerce.com:443/2.0.18/SvcInfo";
	private static String _secondaryServiceEndpoint = "https://cws-02.cert.ipcommerce.com:443/2.0.18/SvcInfo";
	private static String _primaryTxnEndpoint = "https://cws-01.cert.ipcommerce.com:443/2.0.18/Txn";
	private static String _secondaryTxnEndpoint = "https://cws-02.cert.ipcommerce.com:443/2.0.18/Txn";
	private static String _primaryTMSEndpoint = "https://cws-01.cert.ipcommerce.com:443/2.0.18/DataServices/TMS";
	private static String _secondaryTMSEndpoint = "https://cws-02.cert.ipcommerce.com:443/2.0.18/DataServices/TMS";
	// *** Please reference developers guide about protecting the Identity Token *** 
	//https://mylab.ipcommerce.com/Docs/TransactionProcessing/CWS/Developer_Guide/2.0.18/IntegrationGuidance/ServiceInformationGuidelines/SignOnAuthentication/IdentityTokens.aspx
	...
	public com.ipcommerce.schemas.cws.v2_0.serviceinformation.ICWSServiceInformation CWSSIC;
	public com.ipcommerce.schemas.cws.v2_0.transactionprocessing.ICwsTransactionProcessing CWSBC;
	public com.ipcommerce.schemas.cws.v2_0.dataservices.tms.ITMSOperations CWSTMS;
	...
	public boolean SaveMerchantProfile(ConfigurationValues _CV) {
		...
		try {
			...
			BTDD.setRequestACI(com.ipcommerce.schemas.cws.v2_0.serviceinformation.RequestACI.IS_CPS_MERIT_CAPABLE); // If AVS is supported set to "IS_CPS_MERIT_CAPABLE"
...
/// The following is used for Transaction Processing
	...
	public boolean AuthorizeAndCapture(ConfigurationValues _CV, boolean ProcessAsPINDebit) {
		 ...
		 * https://mylab.ipcommerce.com/Docs/TransactionProcessing/CWS/Developer_Guide/2.0.18/Implementation/TransactionProcessing/AuthorizingTransactions/AuthorizeAndCapture.aspx
		*/
	...
	public boolean Authorize(ConfigurationValues _CV) {
		 ...
		 * https://mylab.ipcommerce.com/Docs/TransactionProcessing/CWS/Developer_Guide/2.0.18/Implementation/TransactionProcessing/AuthorizingTransactions/Authorize.aspx
		 */
	...
	public boolean Adjust(ConfigurationValues _CV) {
		 ...
		 * https://mylab.ipcommerce.com/Docs/TransactionProcessing/CWS/Developer_Guide/2.0.18/Implementation/TransactionProcessing/AdjustingVoidingTransactions/Adjust.aspx
		*/ 
	...
	public boolean Undo(ConfigurationValues _CV) {
		 ...
		 * https://mylab.ipcommerce.com/Docs/TransactionProcessing/CWS/Developer_Guide/2.0.18/Implementation/TransactionProcessing/AdjustingVoidingTransactions/Undo.aspx
		*/ 
		try {
			checkTokenExpire(_CV);// Always verify that the session token has not expired.
	...
	public boolean Capture(ConfigurationValues _CV) {
		 ...
		 * https://mylab.ipcommerce.com/Docs/TransactionProcessing/CWS/Developer_Guide/2.0.18/Implementation/TransactionProcessing/CapturingTransactions/Capture.aspx
		*/ 
		try {
			checkTokenExpire(_CV);// Always verify that the session token has not expired.
	...
	public boolean CaptureAll(ConfigurationValues _CV) {
		 ...
		 * https://mylab.ipcommerce.com/Docs/TransactionProcessing/CWS/Developer_Guide/2.0.18/Implementation/TransactionProcessing/CapturingTransactions/CaptureAll.aspx
		 */
		try {
			checkTokenExpire(_CV);// Always verify that the session token has not expired.
			...
			if(_CV.ServiceToProcessAs == "BankcardService" && _CV._bcs != null){
				...
				AOR = (ArrayOfResponse) CWSBC.captureAll(_CV._SessionToken, null, null, _CV._ApplicationProfileId, _CV._BCPMerchantProfileId, _CV._bcs.getServiceId());
				...
				ArrayOfResponse AOR = new ArrayOfResponse();
				AOR = (ArrayOfResponse) CWSBC.captureAll(_CV._SessionToken, null, null, _CV._ApplicationProfileId, _CV._ECKMerchantProfileId, _CV._ecks.getServiceId());
				java.util.List<Response> R = AOR.getResponse(); 
				R = AOR.getResponse(); 
				for (Response ECCR : R)
				{
	...
	public boolean CaptureSelective(ConfigurationValues _CV) {
		 ...
		 * https://mylab.ipcommerce.com/Docs/TransactionProcessing/CWS/Developer_Guide/2.0.18/Implementation/TransactionProcessing/CapturingTransactions/CaptureSelective.aspx
		 */
		try {
			checkTokenExpire(_CV);// Always verify that the session token has not expired.
	...
	public boolean ReturnById(ConfigurationValues _CV) {
		 ...
		 * https://mylab.ipcommerce.com/Docs/TransactionProcessing/CWS/Developer_Guide/2.0.18/Implementation/TransactionProcessing/RefundingTransactions/ReturnById.aspx
		*/ 
		try {
			checkTokenExpire(_CV);// Always verify that the session token has not expired.
	...
	public boolean ReturnUnlinked(ConfigurationValues _CV) {
		 ...
		 * https://mylab.ipcommerce.com/Docs/TransactionProcessing/CWS/Developer_Guide/2.0.18/Implementation/TransactionProcessing/RefundingTransactions/ReturnUnlinked.aspx
		*/ 
		try {
			checkTokenExpire(_CV);// Always verify that the session token has not expired.
	...
	public boolean Verify(ConfigurationValues _CV) {
		 ...
		 * https://mylab.ipcommerce.com/Docs/TransactionProcessing/CWS/Developer_Guide/2.0.18/Implementation/TransactionProcessing/OptionalOperations/Verify.aspx
		 */
	...
	public boolean QueryAccount(ConfigurationValues _CV) {
		 ...
		 * https://mylab.ipcommerce.com/Docs/TransactionProcessing/CWS/Developer_Guide/2.0.18/Implementation/TransactionProcessing/OptionalOperations/QueryAccount.aspx
		*/ 
		try {
			checkTokenExpire(_CV);// Always verify that the session token has not expired.
...
/// The following are helper methods
	...
	{
        try {
            com.ipcommerce.schemas.cws.v2_0.serviceinformation.faults.CWSBaseFault faultInfo = (com.ipcommerce.schemas.cws.v2_0.serviceinformation.faults.CWSBaseFault) _e.getClass().getMethod("getFaultInfo", null).invoke(_e, null);
            System.out.println("FAULT: " + faultInfo.getErrorID() + ": " + faultInfo.getProblemType());
            if (faultInfo instanceof  com.ipcommerce.schemas.cws.v2_0.serviceinformation.faults.CWSValidationResultFault)
            {
            	com.ipcommerce.schemas.cws.v2_0.serviceinformation.faults.CWSValidationResultFault valFault = (com.ipcommerce.schemas.cws.v2_0.serviceinformation.faults.CWSValidationResultFault) faultInfo;
    			Iterator<com.ipcommerce.schemas.cws.v2_0.serviceinformation.faults.CWSValidationErrorFault> iter = valFault.getErrors().getCWSValidationErrorFault().iterator();
            	while (iter.hasNext())
            	{
            		com.ipcommerce.schemas.cws.v2_0.serviceinformation.faults.CWSValidationErrorFault err = iter.next();
