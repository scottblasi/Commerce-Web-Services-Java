...
public class ITMSOperationsQueryTransactionFamiliesExpiredTokenFaultFaultFaultMessage extends Exception {
    ...
    public ITMSOperationsQueryTransactionFamiliesExpiredTokenFaultFaultFaultMessage(String message, com.ipcommerce.schemas.identity._1.ExpiredTokenFault expiredTokenFault) {
        super(message);
        this.expiredTokenFault = expiredTokenFault;
    }

    public ITMSOperationsQueryTransactionFamiliesExpiredTokenFaultFaultFaultMessage(String message, com.ipcommerce.schemas.identity._1.ExpiredTokenFault expiredTokenFault, Throwable cause) {
        super(message, cause);
        this.expiredTokenFault = expiredTokenFault;
    }
