 ...
 *         &lt;element name="CreditAuthorizeSupport" type="{http://schemas.ipcommerce.com/CWS/v2.0/ServiceInformation}CreditAuthorizeSupportType" minOccurs="0"/>
 *         &lt;element name="QueryRejectedSupport" type="{http://schemas.ipcommerce.com/CWS/v2.0/ServiceInformation}QueryRejectedSupportType" minOccurs="0"/>
 *         &lt;element name="PinDebitUndoSupport" type="{http://schemas.ipcommerce.com/CWS/v2.0/ServiceInformation}PinDebitUndoSupportType" minOccurs="0"/>
 *         &lt;element name="BatchAssignmentSupport" type="{http://schemas.ipcommerce.com/CWS/v2.0/ServiceInformation}BatchAssignmentSupport" minOccurs="0"/>
 *         &lt;element name="CreditReturnSupportType" type="{http://schemas.ipcommerce.com/CWS/v2.0/ServiceInformation}CreditReturnSupportType" minOccurs="0"/>
 *         &lt;element name="TrackDataSupport" type="{http://schemas.ipcommerce.com/CWS/v2.0/ServiceInformation}TrackDataSupportType" minOccurs="0"/>
 *         &lt;element name="CredentialsRequired" type="{http://www.w3.org/2001/XMLSchema}boolean" minOccurs="0"/>
 *         &lt;element name="CreditReversalSupportType" type="{http://schemas.ipcommerce.com/CWS/v2.0/ServiceInformation}CreditReversalSupportType" minOccurs="0"/>
 *         &lt;element name="PartialApprovalSupportType" type="{http://schemas.ipcommerce.com/CWS/v2.0/ServiceInformation}PartialApprovalSupportType" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
