 ...
 * generated in the com.ipcommerce.schemas.cws.v2_0.dataservices package. 
...
public class ObjectFactory {
    ...
    private final static QName _PagingParameters_QNAME = new QName("http://schemas.ipcommerce.com/CWS/v2.0/DataServices", "PagingParameters");
    private final static QName _DateRange_QNAME = new QName("http://schemas.ipcommerce.com/CWS/v2.0/DataServices", "DateRange");
    private final static QName _DataServicesUnavailableFault_QNAME = new QName("http://schemas.ipcommerce.com/CWS/v2.0/DataServices", "DataServicesUnavailableFault");
    private final static QName _DSBaseFault_QNAME = new QName("http://schemas.ipcommerce.com/CWS/v2.0/DataServices", "DSBaseFault");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.ipcommerce.schemas.cws.v2_0.dataservices
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://schemas.ipcommerce.com/CWS/v2.0/DataServices", name = "PagingParameters")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://schemas.ipcommerce.com/CWS/v2.0/DataServices", name = "DateRange")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://schemas.ipcommerce.com/CWS/v2.0/DataServices", name = "DataServicesUnavailableFault")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://schemas.ipcommerce.com/CWS/v2.0/DataServices", name = "DSBaseFault")
