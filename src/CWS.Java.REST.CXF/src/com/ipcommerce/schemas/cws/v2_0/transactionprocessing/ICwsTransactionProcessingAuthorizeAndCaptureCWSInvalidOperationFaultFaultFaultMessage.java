...
public class ICwsTransactionProcessingAuthorizeAndCaptureCWSInvalidOperationFaultFaultFaultMessage extends Exception {
    ...
    public ICwsTransactionProcessingAuthorizeAndCaptureCWSInvalidOperationFaultFaultFaultMessage(String message, com.ipcommerce.schemas.cws.v2_0.transactions.faults.CWSInvalidOperationFault cwsInvalidOperationFault) {
        super(message);
        this.cwsInvalidOperationFault = cwsInvalidOperationFault;
    }

    public ICwsTransactionProcessingAuthorizeAndCaptureCWSInvalidOperationFaultFaultFaultMessage(String message, com.ipcommerce.schemas.cws.v2_0.transactions.faults.CWSInvalidOperationFault cwsInvalidOperationFault, Throwable cause) {
        super(message, cause);
        this.cwsInvalidOperationFault = cwsInvalidOperationFault;
    }
