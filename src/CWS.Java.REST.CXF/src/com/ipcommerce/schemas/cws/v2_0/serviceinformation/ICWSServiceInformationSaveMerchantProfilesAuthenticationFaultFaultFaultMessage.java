...
public class ICWSServiceInformationSaveMerchantProfilesAuthenticationFaultFaultFaultMessage extends Exception {
    ...
    public ICWSServiceInformationSaveMerchantProfilesAuthenticationFaultFaultFaultMessage(String message, com.ipcommerce.schemas.identity._1.AuthenticationFault authenticationFault) {
        super(message);
        this.authenticationFault = authenticationFault;
    }

    public ICWSServiceInformationSaveMerchantProfilesAuthenticationFaultFaultFaultMessage(String message, com.ipcommerce.schemas.identity._1.AuthenticationFault authenticationFault, Throwable cause) {
        super(message, cause);
        this.authenticationFault = authenticationFault;
    }
