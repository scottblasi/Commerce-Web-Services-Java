...
public class ICWSServiceInformationDeleteMerchantProfileInvalidTokenFaultFaultFaultMessage extends Exception {
    ...
    public ICWSServiceInformationDeleteMerchantProfileInvalidTokenFaultFaultFaultMessage(String message, com.ipcommerce.schemas.identity._1.InvalidTokenFault invalidTokenFault) {
        super(message);
        this.invalidTokenFault = invalidTokenFault;
    }

    public ICWSServiceInformationDeleteMerchantProfileInvalidTokenFaultFaultFaultMessage(String message, com.ipcommerce.schemas.identity._1.InvalidTokenFault invalidTokenFault, Throwable cause) {
        super(message, cause);
        this.invalidTokenFault = invalidTokenFault;
    }
