 ...
 * generated in the com.ipcommerce.schemas.cws.v2_0.dataservices.tms.faults package. 
...
public class ObjectFactory {
    ...
    private final static QName _TMSUnknownServiceKeyFault_QNAME = new QName("http://schemas.ipcommerce.com/CWS/v2.0/DataServices/TMS/Faults", "TMSUnknownServiceKeyFault");
    private final static QName _TMSBaseFault_QNAME = new QName("http://schemas.ipcommerce.com/CWS/v2.0/DataServices/TMS/Faults", "TMSBaseFault");
    private final static QName _TMSTransactionFailedFault_QNAME = new QName("http://schemas.ipcommerce.com/CWS/v2.0/DataServices/TMS/Faults", "TMSTransactionFailedFault");
    private final static QName _TMSOperationNotSupportedFault_QNAME = new QName("http://schemas.ipcommerce.com/CWS/v2.0/DataServices/TMS/Faults", "TMSOperationNotSupportedFault");
    private final static QName _TMSUnavailableFault_QNAME = new QName("http://schemas.ipcommerce.com/CWS/v2.0/DataServices/TMS/Faults", "TMSUnavailableFault");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.ipcommerce.schemas.cws.v2_0.dataservices.tms.faults
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://schemas.ipcommerce.com/CWS/v2.0/DataServices/TMS/Faults", name = "TMSUnknownServiceKeyFault")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://schemas.ipcommerce.com/CWS/v2.0/DataServices/TMS/Faults", name = "TMSBaseFault")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://schemas.ipcommerce.com/CWS/v2.0/DataServices/TMS/Faults", name = "TMSTransactionFailedFault")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://schemas.ipcommerce.com/CWS/v2.0/DataServices/TMS/Faults", name = "TMSOperationNotSupportedFault")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://schemas.ipcommerce.com/CWS/v2.0/DataServices/TMS/Faults", name = "TMSUnavailableFault")
