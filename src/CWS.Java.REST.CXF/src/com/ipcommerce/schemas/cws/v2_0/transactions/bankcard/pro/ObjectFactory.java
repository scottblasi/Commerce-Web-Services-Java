 ...
 * generated in the com.ipcommerce.schemas.cws.v2_0.transactions.bankcard.pro package. 
...
public class ObjectFactory {
    ...
    private final static QName _BankcardReturnPro_QNAME = new QName("http://schemas.ipcommerce.com/CWS/v2.0/Transactions/Bankcard/Pro", "BankcardReturnPro");
    private final static QName _BankcardCapturePro_QNAME = new QName("http://schemas.ipcommerce.com/CWS/v2.0/Transactions/Bankcard/Pro", "BankcardCapturePro");
    private final static QName _BankcardTransactionResponsePro_QNAME = new QName("http://schemas.ipcommerce.com/CWS/v2.0/Transactions/Bankcard/Pro", "BankcardTransactionResponsePro");
    private final static QName _BankcardCaptureResponsePro_QNAME = new QName("http://schemas.ipcommerce.com/CWS/v2.0/Transactions/Bankcard/Pro", "BankcardCaptureResponsePro");
    private final static QName _BankcardTransactionPro_QNAME = new QName("http://schemas.ipcommerce.com/CWS/v2.0/Transactions/Bankcard/Pro", "BankcardTransactionPro");
    private final static QName _BankcardInterchangeData_QNAME = new QName("http://schemas.ipcommerce.com/CWS/v2.0/Transactions/Bankcard/Pro", "BankcardInterchangeData");
    private final static QName _BankcardTransactionDataPro_QNAME = new QName("http://schemas.ipcommerce.com/CWS/v2.0/Transactions/Bankcard/Pro", "BankcardTransactionDataPro");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.ipcommerce.schemas.cws.v2_0.transactions.bankcard.pro
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://schemas.ipcommerce.com/CWS/v2.0/Transactions/Bankcard/Pro", name = "BankcardReturnPro")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://schemas.ipcommerce.com/CWS/v2.0/Transactions/Bankcard/Pro", name = "BankcardCapturePro")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://schemas.ipcommerce.com/CWS/v2.0/Transactions/Bankcard/Pro", name = "BankcardTransactionResponsePro")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://schemas.ipcommerce.com/CWS/v2.0/Transactions/Bankcard/Pro", name = "BankcardCaptureResponsePro")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://schemas.ipcommerce.com/CWS/v2.0/Transactions/Bankcard/Pro", name = "BankcardTransactionPro")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://schemas.ipcommerce.com/CWS/v2.0/Transactions/Bankcard/Pro", name = "BankcardInterchangeData")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://schemas.ipcommerce.com/CWS/v2.0/Transactions/Bankcard/Pro", name = "BankcardTransactionDataPro")
