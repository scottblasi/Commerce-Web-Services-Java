...
public class ICwsTransactionProcessingCaptureSelectiveAsyncInvalidTokenFaultFaultFaultMessage extends Exception {
    ...
    public ICwsTransactionProcessingCaptureSelectiveAsyncInvalidTokenFaultFaultFaultMessage(String message, com.ipcommerce.schemas.identity._1.InvalidTokenFault invalidTokenFault) {
        super(message);
        this.invalidTokenFault = invalidTokenFault;
    }

    public ICwsTransactionProcessingCaptureSelectiveAsyncInvalidTokenFaultFaultFaultMessage(String message, com.ipcommerce.schemas.identity._1.InvalidTokenFault invalidTokenFault, Throwable cause) {
        super(message, cause);
        this.invalidTokenFault = invalidTokenFault;
    }
