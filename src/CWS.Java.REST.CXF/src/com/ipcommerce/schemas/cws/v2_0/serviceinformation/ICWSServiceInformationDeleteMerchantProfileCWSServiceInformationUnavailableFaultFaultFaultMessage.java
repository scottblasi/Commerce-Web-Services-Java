...
public class ICWSServiceInformationDeleteMerchantProfileCWSServiceInformationUnavailableFaultFaultFaultMessage extends Exception {
    ...
    public ICWSServiceInformationDeleteMerchantProfileCWSServiceInformationUnavailableFaultFaultFaultMessage(String message, com.ipcommerce.schemas.cws.v2_0.serviceinformation.faults.CWSServiceInformationUnavailableFault cwsServiceInformationUnavailableFault) {
        super(message);
        this.cwsServiceInformationUnavailableFault = cwsServiceInformationUnavailableFault;
    }

    public ICWSServiceInformationDeleteMerchantProfileCWSServiceInformationUnavailableFaultFaultFaultMessage(String message, com.ipcommerce.schemas.cws.v2_0.serviceinformation.faults.CWSServiceInformationUnavailableFault cwsServiceInformationUnavailableFault, Throwable cause) {
        super(message, cause);
        this.cwsServiceInformationUnavailableFault = cwsServiceInformationUnavailableFault;
    }
