 ...
 * generated in the com.ipcommerce.schemas.cws.v2_0.serviceinformation.faults package. 
...
public class ObjectFactory {
    ...
    private final static QName _CWSFault_QNAME = new QName("http://schemas.ipcommerce.com/CWS/v2.0/ServiceInformation/Faults", "CWSFault");
    private final static QName _CWSValidationResultFault_QNAME = new QName("http://schemas.ipcommerce.com/CWS/v2.0/ServiceInformation/Faults", "CWSValidationResultFault");
    private final static QName _CWSValidationErrorFault_QNAME = new QName("http://schemas.ipcommerce.com/CWS/v2.0/ServiceInformation/Faults", "CWSValidationErrorFault");
    private final static QName _CWSBaseFault_QNAME = new QName("http://schemas.ipcommerce.com/CWS/v2.0/ServiceInformation/Faults", "CWSBaseFault");
    private final static QName _CWSValidationErrorFaultEErrorType_QNAME = new QName("http://schemas.ipcommerce.com/CWS/v2.0/ServiceInformation/Faults", "CWSValidationErrorFault.EErrorType");
    private final static QName _CWSServiceInformationUnavailableFault_QNAME = new QName("http://schemas.ipcommerce.com/CWS/v2.0/ServiceInformation/Faults", "CWSServiceInformationUnavailableFault");
    private final static QName _ArrayOfCWSValidationErrorFault_QNAME = new QName("http://schemas.ipcommerce.com/CWS/v2.0/ServiceInformation/Faults", "ArrayOfCWSValidationErrorFault");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.ipcommerce.schemas.cws.v2_0.serviceinformation.faults
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://schemas.ipcommerce.com/CWS/v2.0/ServiceInformation/Faults", name = "CWSFault")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://schemas.ipcommerce.com/CWS/v2.0/ServiceInformation/Faults", name = "CWSValidationResultFault")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://schemas.ipcommerce.com/CWS/v2.0/ServiceInformation/Faults", name = "CWSValidationErrorFault")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://schemas.ipcommerce.com/CWS/v2.0/ServiceInformation/Faults", name = "CWSBaseFault")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://schemas.ipcommerce.com/CWS/v2.0/ServiceInformation/Faults", name = "CWSValidationErrorFault.EErrorType")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://schemas.ipcommerce.com/CWS/v2.0/ServiceInformation/Faults", name = "CWSServiceInformationUnavailableFault")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://schemas.ipcommerce.com/CWS/v2.0/ServiceInformation/Faults", name = "ArrayOfCWSValidationErrorFault")
